  ...
  return (
    <section className="w-full bg-[#faf9f6] py-24 px-4 flex flex-col items-center relative z-10">
      ...
      <div className="relative mt-12 w-full max-w-lg flex flex-col items-center">
        <div className="absolute top-0 bottom-0 left-1/2 -ml-[1px] w-[2px] bg-red-700" />
        ...
        {timelineEvents.map((event, index) => {
          ...
          return (
            ...
            >
              <div className="w-14 h-14 rounded-full bg-red-700 flex items-center justify-center text-white border-4 border-white shadow-md mb-6 relative shadow-burgundy/10">
